...
export default function HouseForm({ house }: IProps) {
  ...
  useEffect(() => {
    register({ name: "address" }, { required: "Please enter address" });
  ...
  return (
    <form className="mx-auto max-w-xl py-4" onSubmit={handleSubmit(onSubmit)}>
      <h1 className="text-xl">
        {house ? `Editing ${house.address}` : "Add New House"}
      </h1>
      ...
      {address && (
        <>
          ...
          <div className="mt-4">
            ...
            <input
              ...
              ref={register({
                ...
                max: { value: 10, message: "Wooahh, to big of a house" },
                min: { value: 1, message: "Must have a least 1 bedroom" },
              })}
            />
          ...
          <div className="mt-4">
            <button className="bg-blue-500 hover:bg-blue-700 font-bold py-2 px-4 rounded mr-2">
              Submit
            </button>
